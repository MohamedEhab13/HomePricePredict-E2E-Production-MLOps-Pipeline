...
# Define abstract class for data inspection 
class DataInspectorStrategy(ABC):
    @abstractmethod
    def inspect(self, df : pd.DataFrame):
        """Apply specific inspection on given DataFrame"""
        pass 

# Implement data type inspector class  
class DataTypeInspector(DataInspectorStrategy):
    def inspect(self, df : pd.DataFrame):         
        """Display the data type and non-null count of DataFrame columns"""  
        print("\nData Types and Non-null Counts:")
        print(df.info())


# Implement summary statistics inspector class  
class SummaryStatisticsInspector(DataInspectorStrategy):
    def inspect(self, df : pd.DataFrame):         
...
# Implement context class to switch between different data inspection strategies 
class DataInspector:
    def __init__(self, strategy : DataInspectorStrategy):
        """Initialize DataInspector with specific Inspection strategy"""
        self._strategy = strategy

    def set_strategy(self, strategy : DataInspectorStrategy):
        """Set DataInspector strategy to new inspection strategy"""
        self._strategy = strategy

    def execute_inspect(self, df : pd.DataFrame):
        """Apply specific inspection on given DataFrame"""
