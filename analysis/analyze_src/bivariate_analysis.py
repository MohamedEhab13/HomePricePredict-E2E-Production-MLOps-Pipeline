...
# Define abstract class for bivariate analysis
class BivariateAnalyzerBase(ABC):
    @abstractmethod
    def analyze(self, df: pd.DataFrame, feature: set):
        """Analyze the relation between two features"""
        pass 

# Implement bivariate analysis class for numerical features 
class NumBivariateAnalyzer(BivariateAnalyzerBase):
    def analyze(self, df, feature1, feature2):
        """Display scatter plot of a given two numerical feature"""
...
# Implement bivariate analysis class analysing the relation between two features  
class NumCatUnivariateAnalyzer(BivariateAnalyzerBase):
    def analyze(self, df, feature1, feature2):
        """Display IQR of numerical feature with respect to categorical feature"""
        plt.figure(figsize=(15,15)) 
...
# Implement top class to switch between different types of univariate analysis 
class BivariateAnalyzer:
    def __init__(self, strategy: BivariateAnalyzerBase):
        """Get the strategy type of the univariate analysis"""
        self._strategy = strategy

    def set_strategy(self, strategy: BivariateAnalyzerBase):
        """Get new strategy type of the univariate analysis"""
        self._strategy = strategy

    def execute_analysis(self, df: pd.DataFrame, feature1: str, feature2: str):
        """Excute the strategy of univariate analysis on given DataFrame"""
