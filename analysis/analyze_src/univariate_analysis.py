...
# Define abstract class for univariate analysis
class UnivariateAnalyzerBase(ABC):
    @abstractmethod
    def analyze(self, df: pd.DataFrame, feature: set):
        """Display the distribution of a given feature"""
        pass 

# Implement univariate analysis class for numerical features 
class NumUnivariateAnalyzer(UnivariateAnalyzerBase):
    def analyze(self, df, feature):
        """Display the distribution of a given numerical feature"""
...
# Implement univariate analysis class for categorical features 
class CatUnivariateAnalyzer(UnivariateAnalyzerBase):
    def analyze(self, df, feature):
        """Display the distribution of a given categorical feature"""
        plt.figure(figsize=(15,15)) 
...
class UnivariateAnalyzer:
    def __init__(self, strategy: UnivariateAnalyzerBase):
        """Get the strategy type of the univariate analysis"""
        self._strategy = strategy

    def set_strategy(self, strategy: UnivariateAnalyzerBase):
