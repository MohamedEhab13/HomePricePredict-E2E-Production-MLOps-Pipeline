...
# Template class for MultiVariate Analysis
class MultiVariateAnalyzerBase(ABC):
    def analyze(self, df: pd.DataFrame):
        """
        Analyze given DataFrame and display heatmap for features correlation 
        and scatter plot each feature along with other features
        """
        self.CorrelationHeatMap(df)
        self.PairPlot(df) 
    
    @abstractmethod
    def CorrelationHeatMap(self, df: pd.DataFrame):
        """Analyze given DataFrame and display heatmap for features correlation"""
        pass 
    ...
    def PairPlot(self, df: pd.DataFrame):
        """
        Analyze given DataFrame and display scatter plot for
        each feature along with other features
        """
        pass 


# Concrete class for MultiVariate analysis
class MultiVariateAnalyzer(MultiVariateAnalyzerBase):
    def CorrelationHeatMap(self, df):
        """Analyze given DataFrame and display heatmap for features correlation"""
